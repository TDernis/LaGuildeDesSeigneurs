...
class CharacterApiHtmlController extends AbstractController
{
    ...
    public function indexIntelligence(int $intelligence): Response
    {
        $response = $this->client->request(
            'GET',
            'http://caddy/character/intelligence/'.$intelligence);
        return $this->render('character_api_html/index.html.twig', [
            'characters' => $response->toArray()
        ]);
    }
    ...
    public function show(string $identifier): Response
    {
        $response = $this->client->request(
            'GET',
            'http://caddy/character/display/' . $identifier);
    ...
    public function delete(Request $request, string $identifier): Response
    {
        if ($this->isCsrfTokenValid('delete'.$identifier, $request->request->get('_token'))) {
            $this->client->request(
                'DELETE',
                'http://caddy/character/delete/' . $identifier);
        }
